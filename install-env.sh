...
aws ec2 run-instances --image-id $1 --key-name $2 --security-group-ids $3 --instance-type t2.micro  --iam-instance-profile Name=$6  --user-data file://installapp.sh --count 1 --placement AvailabilityZone=us-west-2b
